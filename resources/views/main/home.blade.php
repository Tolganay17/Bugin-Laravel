    ...
    <div class="top-news">
            ...
            <div class="news-slider-wrapper">
                ...
                <div class="news-slider">
                   ...
                   <div class="news-slider-img">
                    ...
                    <a href="{{url('post')}}/{{$k->slug}}">
                        <div class="news-slider-caption">
                            <h2>{{$k->title}}</h2>
                            <span>2 сағат бұрын</span>
                        </div>
                    </a>
                    <a class="cats society" href="{{url('post')}}/{{$k->slug}}">Қоғам</a>
        ...
        <div class="sm-news-wrapper">
          <div class="sm-news-item">
                @foreach($weekend as $key=>$w)
                @if($key == 0)
                <a href="{{url('posts')}}/{{$w->slug}}">
                    <div class="sm-news">
            ...
            <div class="sm-news-item">
                @foreach($covid as $key=>$c)
                @if($key == 0)
                <a href="{{url('posts')}}/{{$c->slug}}">
                    <div class="sm-news">
                        <div class="sm-news-img">
                            <img src="{{ asset('uploads/'.$c->image)}}">
                        </div>
                        <div class="sm-news-caption">
                            <h2>{{$c->title}}</h2>
                            <span>2 сағат бұрын</span>
                ...
                <a class="cats covid" href="{{url('posts')}}/{{$c->slug}}">COVID-19</a>
                @endif
                @endforeach
            </div>
            <div class="sm-news-item">
                @foreach($bilim as $key=>$b)
                @if($key == 0)
                <a href="{{url('posts')}}/{{$b->slug}}">
                    <div class="sm-news">
                        <div class="sm-news-img">
                ...
                <a class="cats weekend" href="{{url('posts')}}/{{$b->slug}}">Білім</a>
                @endif
                @endforeach
            </div>
            <div class="sm-news-item">
                ...
                @if($key == 0)
                <a href="{{url('posts')}}/{{$n->slug}}">
                    <div class="sm-news">
                        <div class="sm-news-img">
                            <img src="{{ asset('uploads/'.$n->image)}}  ">
                        </div>
                        <div class="sm-news-caption">
                            <h2>{{$n->title}}</h2>
                            <span>2 сағат бұрын</span>
                ...
                <a class="cats world" href="{{url('posts')}}/{{$n->slug}}">Әлем жаңалықтары</a>
                @endif
                @endforeach
            </div>
            <div class="sm-news-item">
                @foreach($kogam as $key=>$k)
                @if($key == 0)
                <a href="{url('posts')}}/{{$k->slug}}">
                    <div class="sm-news">
                        <div class="sm-news-img">
                            <img src="{{ asset('uploads/'.$k->image)}}">
                        </div>
                ...
                <a class="cats society" href="{{url('posts')}}/{{$k->slug}}">Қоғам</a>
                @endif
                @endforeach
            </div>
            <div class="sm-news-item">
                ...
                <a class="cats weekend" href="{{url('posts')}}/{{$w->slug}}">WEEKEND</a>
                @endif
                @endforeach
            </div>
            <div class="sm-news-item d-lg-none d-xl-block">
                <a href="#">
                    <div class="sm-news">
                        <div class="sm-news-img">
                            <img src=" {{ asset('img/content/sm-news7.png')}}">
                        </div>
                        <div class="sm-news-caption">
                            <h2>Samsung сатылымға шектеулі шыққан Galaxy Z Fold2 смартфонын таныстырды</h2>
                            <span>2 сағат бұрын</span>
                        </div>
                    </div>
                </a>
                <a class="cats weekend" href="#">HI-TECH</a>
            </div>
            <div class="sm-news-item d-lg-none d-xl-block">
                <a href="#">
                    <div class="sm-news">
                        <div class="sm-news-img">
                            <img src=" {{ asset('img/content/sm-news8.png')}}">
                        </div>
                        <div class="sm-news-caption">
                            <h2>Түркістан облысында қайтарымсыз грантпен кәсібін дамытқандар көбейіп келеді</h2>
                            <span>2 сағат бұрын</span>
                        </div>
                    </div>
                </a>
...
<div class="container">
    <div class="author">
        <div class="author-top">
            ...
            <a class="author-open" href="#">Барлығын көру</a>
        </div>
